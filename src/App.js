    ...
    <div className="App" style={{ marginTop: sticky.offset }}>
      ...
      <div className="row">
        <div className="main">
          ...
          <img className="fakeimg" alt="Description of the" src="https://pixune.com/wp-content/uploads/2023/11/DALL·E-2023-11-30-12.59.03-A-whimsical-and-colorful-illustration-of-an-artist-surrounded-by-a-whirlwind-of-various-art-styles-and-influences.-The-artist-a-middle-aged-Caucasian-1030x589.webp" />
